...
const featureList: FeatureProps[] = [
  // ...removed Visualize Datasets button...
  {
    title: "Stacks",
    description:
...
export const Navbar = () => {
  ...
  return (
    <header className="shadow-inner bg-opacity-15 w-[90%] md:w-[70%] lg:w-[75%] lg:max-w-screen-xl top-5 mx-auto border border-secondary z-40 rounded-2xl flex justify-between items-center p-2 bg-card/60 backdrop-blur-md">
